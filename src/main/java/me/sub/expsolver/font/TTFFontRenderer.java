...
public class TTFFontRenderer {
    ...
    public void drawCenteredString(String text, float x, float y, int color) {
        ...
        float height = getHeight(text) / 2.0F;
    ...
    public void drawVerticallyCenteredString(String text, float x, float y, int color) {
        float height = getHeight(text) / 2.0F;
        renderString(text, x, y - height, color, false);
    }
    ...
    public void drawStringWithOutline(String text, float x, float y, int color) { // todo fix with esp
        float offset = 0.5f;
        x = Math.round(x / 0.5f) * 0.5f;
        y = Math.round(y / 0.5f) * 0.5f;
        ...
        renderString(text, x, y, new Color(0x020202).getRGB(), false, true);
        GL11.glTranslated(-(offset*2), 0, 0);
        renderString(text, x, y, new Color(0x020202).getRGB(), false, true);
    ...
    public void drawStringWithOutline(String text, float x, float y, int color, int shadowColor) {
        drawStringWithOutline(text, x, y, color,  shadowColor, 0.5f);
    }


    public void drawStringWithOutline(String text, float x, float y, int color, int shadowColor, float lineWidth, boolean crayCray) {
        ...
        GL11.glTranslated(offset, offset, 0);
        renderString(text, x, y, shadowColor, false);
        ...
        drawStringWithOutline(text, x, y, color, shadowColor, lineWidth);
    }

    public void drawStringWithOutline(String text, float x, float y, int color, int shadowColor, float lineWidth) {
        float offset = lineWidth;
        x = Math.round(x / 0.5f) * 0.5f;
        y = Math.round(y / 0.5f) * 0.5f;
        GL11.glTranslated(offset, 0, 0);
    ...
    public void drawStringWithShadow(String text, float x, float y, int color, int shadowColor) {
    ...
    private int renderString(String text, float x, float y, int color, boolean shadow) {
        return renderString(text, x,  y, color, shadow, false);
    }
     ...
     * @param color  The color of the text.
     */
    private int renderString(String text, float x, float y, int color, boolean shadow, boolean outline) {
    ...
    public float getWidth(String text) {
        return this.getWidth(text, true);
    }
     ...
     */
    public float getWidth(String text, boolean margin) {
    ...
    public float getHeight(String text) {
        return this.getHeight(text, true);
    }
     ...
     */
    public float getHeight(String text, boolean margin) {
